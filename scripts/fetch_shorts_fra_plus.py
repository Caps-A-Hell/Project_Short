...
mesi = ["janvier", "février", "mars", "avril", "mai", "juin",
        "juillet", "août", "septembre", "octobre", "novembre", "décembre"]
oggi = datetime.datetime.now(ZoneInfo("Europe/Paris")).date()
giorno_str = "1er" if oggi.day == 1 else str(oggi.day)
query = f"{giorno_str} {mesi[oggi.month - 1]} {oggi.year}"
